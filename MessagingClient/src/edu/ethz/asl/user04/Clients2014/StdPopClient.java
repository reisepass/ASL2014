...
public class StdPopClient extends StdClient implements Serializable, Runnable {
	/**
	 * FUN FUN FUN FUN 
	 */
	...
	public StdPopClient(int clientID,  MessageAPI2014 capi,
	...
	public void run() {
			...
			while((cfg.experimentLength+cfg.experimentStartTime)>System.currentTimeMillis()){
				...
				ReadPrivateMessageRequest wrq = new  ReadPrivateMessageRequest(clientID, queueID, true, true);
